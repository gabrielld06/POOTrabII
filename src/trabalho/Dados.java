...
public class Dados {
    ...
    // de acordo com as informações entregues pelo usuario. 
    // Caso uma informação seja vazia o dado não é alterado
    public void atualizaPaciente(int i, String novoNome, LocalDate dataNascimento, String endereco, String telefone, String email, String convenio) {
        Paciente paciente = listaPacientes.get(i);
        if (!novoNome.equals("")) {
        ...
        switch (filtro) {
            ...
            case 2:
                ...
                for(Consulta i : listaConsultas) {
                    ...
                    if(i.getData().equals(LocalDate.now().plusDays(1)) &&
                            !i.getPaciente().getTelefone().equals("")) {
                        consultas.add(i);
                    }
                }   break;
            default:
