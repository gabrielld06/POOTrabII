...
public class Secretaria extends Usuario {
    ...
    public void cadastraPaciente(Dados dados) {
        ...
        LocalDate dataNascimento = LocalDate.parse(leitura.nextLine());
        ...
        novoPaciente.setEmail(contatoEmail);
        novoPaciente.setTelefone(contatoTelefone);
    ...
    public void atualizaPaciente(Dados dados) {
        ...
        if(indice != -1) {
            ...
            dados.atualizaPaciente(indice, novoNome, dataNascimento, endereco, contatoTelefone, contatoEmail, convenio);
